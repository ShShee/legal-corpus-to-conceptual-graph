query_data = [
    ...
    "Hồ sơ đề nghị hưởng hỗ trợ đào tạo, bồi dưỡng, nâng cao trình độ kỹ năng nghề để duy trì việc làm cho người lao động theo quy định gồm những gì?",
    ...
    "Nguyên tắc của bảo hiểm y tế theo quy định là như thế nào ?",
    ...
    "Trường hợp nào được bảo lưu hưởng trợ cấp thất nghiệp ?",
    "Thời gian bảo lưu hưởng trợ cấp thất nghiệp được tính như thế nào ?",
